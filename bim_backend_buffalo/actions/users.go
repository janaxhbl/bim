...
func (v UsersResource) List(c buffalo.Context) error {
	...
	// Eager load CodeSnippets for Users
	for i := range *users {
		if err := tx.Load(&(*users)[i], "CodeSnippets"); err != nil {
			return err
		}
	}
...
func (v UsersResource) Show(c buffalo.Context) error {
	...
	// Eager load CodeSnippets for this User
	if err := tx.Load(user, "CodeSnippets"); err != nil {
		return err
	}
